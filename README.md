...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/cset-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cset-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `cset` available on your platform:
...
```
pixi search cset --channel conda-forge
```
...
* [@Sylviabohnenstengel](https://github.com/Sylviabohnenstengel/)
* [@daflack](https://github.com/daflack/)
* [@james-a-f-ross](https://github.com/james-a-f-ross/)
